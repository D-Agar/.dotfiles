return {
  ...
  init = function()
    ...
    vim.keymap.set({ "v", "n" }, "<localleader>mm", "<Cmd>MoltenEvaluateVisual<CR>")
    vim.keymap.set("n", "<localleader>mm", "<Cmd>MoltenEvaluateLine<CR>")
    ...
    vim.keymap.set("n", "<localleader>ip", function()
      ...
      if venv ~= nil then
        -- in the form of /home/daniel/miniconda3/VENV_NAME
